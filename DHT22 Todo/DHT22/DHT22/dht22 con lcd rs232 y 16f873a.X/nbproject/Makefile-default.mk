...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/dht22_con_lcd_rs232_y_16f873a.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED="dht22 con lcd rs232 y 16f873a.c"

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED="${OBJECTDIR}/dht22 con lcd rs232 y 16f873a.o"
POSSIBLE_DEPFILES="${OBJECTDIR}/dht22 con lcd rs232 y 16f873a.o.d"

# Object Files
OBJECTFILES=${OBJECTDIR}/dht22\ con\ lcd\ rs232\ y\ 16f873a.o

# Source Files
SOURCEFILES=dht22 con lcd rs232 y 16f873a.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/dht22_con_lcd_rs232_y_16f873a.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/dht22\ con\ lcd\ rs232\ y\ 16f873a.o: dht22\ con\ lcd\ rs232\ y\ 16f873a.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR} 
ifeq (1,1) 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/dht22_con_lcd_rs232_y_16f873a.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
ifeq (1,1) 
